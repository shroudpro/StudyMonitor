  ...
  <div class="app-layout">
    ...
    <div class="side-area">
      <div class="card session-controls">
        ...
        <div class="flex gap-2" style="margin-top: var(--space-3)">
            <button v-if="!sessionActive" class="btn btn-primary" @click="handleStartSession" style="flex: 1;">
    ...
    <div v-if="finalStats" class="modal-overlay" @click.self="finalStats = null">
      <div class="modal card">
        ...
        <button class="btn btn-primary" style="width: 100%; margin-top: var(--space-6);" @click="finalStats = null">关闭</button>
      </div>
    </div>
  </div>
</template>
